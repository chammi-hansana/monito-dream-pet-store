    ...
    <div className="bg-gradient-to-r from-[#FCEED5] to-[#FFE7BA] py-20 px-10 md:px-32 font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10">
        <div className="flex flex-wrap justify-center md:justify-start gap-5 md:gap-8">
          <Link href="#home" className="text-[#00171f] font-medium hover:text-[#003459] transition-colors">
            Home
          </Link>
          <Link href="#category" className="text-[#00171f] font-medium hover:text-[#003459] transition-colors">
            Category
          </Link>
          <Link href="#about" className="text-[#00171f] font-medium hover:text-[#003459] transition-colors">
            About
          </Link>
          <Link href="#contact" className="text-[#00171f] font-medium hover:text-[#003459] transition-colors">
            Contact
          </Link>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center text-sm text-[#667479]">
        ...
        <Image src="/images/monito.png" alt="Monito Logo" width={115} height={40} className="my-4 md:my-0" />
