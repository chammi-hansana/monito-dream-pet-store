...
const ProductGallery = () => {
    ...
    <div className="max-w-screen-xl mx-auto py-16 px-5 font-sans w-full mt-10">
      ...
      <div className="flex justify-between items-center w-full mb-10">
        <div className="text-left">
          <div className="w-100 h-[24px] font-[500] text-[16px] leading-6 text-[#000000]">Hard to choose the right products for your pets?</div>
          <div className="w-[367px] h-[36px] font-[700] text-[24px] leading-9 text-[#003459]">Our Products</div>
        </div>
        {/* View More Button */}
  ...
  {products.map((product) => (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg" key={product.id}>
      ...
      <div className="p-3.5">
        <h3 className="text-[#00171f] mb-1 font-[700] text-[16px]">{product.name}</h3>

        {/* Product Type and Size on the Same Line */}
        <div className="flex items-center gap-4 mb-1">
          <div className="flex items-center gap-1">
            <span className="font-[500] text-[12px] leading-[25px] text-[#667479]">Product:</span>
            <span className="font-[700] text-[12px] leading-[25px] text-[#667479]">{product.type}</span>
          </div>

          {product.size && (
            <div className="flex items-center gap-1">
              <span className="font-[500] text-[12px] leading-[25px] text-[#667479]">Size:</span>
              <span className=" font-[700] text-[12px] leading-[25px] text-[#667479]">{product.size}</span>
            </div>
          )}
        </div>

        <div className="w-[248px] h-[20px] font-[700] text-[14px] leading-[20px] text-[#00171F]">{product.price}</div>
